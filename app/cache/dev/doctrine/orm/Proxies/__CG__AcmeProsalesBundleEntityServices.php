 ...
 */
class Services extends \Acme\ProsalesBundle\Entity\Services implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Acme\\ProsalesBundle\\Entity\\Services' . "\0" . 'id', '' . "\0" . 'Acme\\ProsalesBundle\\Entity\\Services' . "\0" . 'nom');
        }
